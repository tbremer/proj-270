import StateList from "components/2020/state";
import { Importance, type State, stateData } from "data/2020/state";
...
export default function Home({ data: states }: RunTimeProps) {
  ...
  const republican = stateData.filter(
    (s) => s.type === Importance.RepublicanNeeds,
  );
  ...
  return (
    <>
      ...
      <h4 style={{ fontWeight: 500, marginTop: 0 }}>
        2020 Presidential Election Tracker
      </h4>
      ...
      <StateList
        title="Big six to watch"
        states={bigsix}
        updaterFunction={updateState}
      />
      <StateList
        title="Democrat needs to win"
        states={democrat}
        updaterFunction={updateState}
      />
      <StateList
        title="Republican needs to win"
        states={republican}
        updaterFunction={updateState}
      />
      <StateList
        ...
        <ul style={{ margin: 0, paddingLeft: "1rem" }}>
          ...
          <li>
            ...
            <a href="//www.kare11.com/article/news/nation-world/how-many-electoral-votes-does-each-state-have-for-2020-presidential-election/507-7b3d52f4-ea66-4bbd-bfcf-3eb29f17586c">
              KARE 11: How many electoral votes does each state get for
